  ...
  return (
    ...
    >
      ...
      <Link key={0} to={`/blind-box/1`}>
        <BlindBoxItem background="banner_tamano_desenfocado_2940x510.png" itemId={0} itemTitle="HappyCows Box" />
      </Link>

      <Link key={2} to={`/blind-box/individual`}>
        <BlindBoxItem background="BANNER-FARM.png" itemId={0} itemTitle="" />
      </Link>

      <Link key={2} to={`/blind-box/pack`}>
        <BlindBoxItem background="packsblack.png" itemId={1} itemTitle="" />
      </Link>
