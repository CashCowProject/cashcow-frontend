...
import { Flex, Image, Text, Tag, Button } from '@pancakeswap-libs/uikit'
  ...
  return (
    <Flex flexDirection="column">
      <Flex justifyContent="space-between">
        ...
        <Button mt="8px" fullWidth onClick={harvestHandler} style={{fontSize: '14px', fontWeight: 400, height: "28px", lineHeight: 1.5, padding: "0 8px", whiteSpace:"nowrap", borderRadius: "16px", width: "80px"}}>
