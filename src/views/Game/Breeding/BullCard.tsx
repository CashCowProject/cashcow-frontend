    ...
    for (let i = 0; i < tokenIds.length; i++) {
      const nftItem = {
        ...
        image:
          ...
          CATTLE_RARITY[parseInt(attrs[i].rarity)] +
          '-' +
          BULL_BREED[parseInt(attrs[i].breed)] +
          '.png',
      ...
      <TitleContainer>
        <MDBContainer className="mt-1">
          {selectedTokenId == 0 ? (
            <MDBView>
              <img
                src="/images/breeding/marcometal.png"
                alt=""
                style={{ position: 'relative', zIndex: '1', margin: '0 auto', width: '200px', height: '200px' }}
              />
              <img
              ...
              />
              <img
                src="/images/breeding/rejilla1.png"
                alt=""
        ...
        <ModalNftsContainer>
          ...
          >
            {selectedNfts.map((nftEachItem, idx) => {
              return <SelectBullCard nftEachItem={nftEachItem} idx={idx} handleSelectNft={handleSelectNft} />
            })}
          </div>
        </ModalNftsContainer>
      </Modal>
