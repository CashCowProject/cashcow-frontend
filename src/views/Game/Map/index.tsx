...
const Map = () => {
  ...
  return (
    ...
    >
      <FrameDiv>
        <VideoContainer autoPlay muted onLoadedData={() => setLoading(false)} onEnded={() => setPlaying(true)}>
          <source
        ...
        {playing ? (
          <>
            ...
            />
            <MyNftsLink src="/images/map/icons/mynft.png" onClick={() => (window.location.href = '/myNFTs')} />
            <MyDashboardLink
            ...
            />
            <BreedLink src="/images/map/icons/breed.png" onClick={() => (window.location.href = '/farm/breeding')} />
          </>
        ) : (
          <></>
        )}
