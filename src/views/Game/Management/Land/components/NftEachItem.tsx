...
const NftEachItem = ({ image,  tokenId, rarity}) => {
  ...
  const removeItemHandler =async () =>{
    try{
      ...
      let _totalCowLimit = await farmContract.methods._totalCowLimitOf(account).call()
      let _totalBullLimit = await farmContract.methods._totalBullLimitOf(account).call()
      let _cowLimitPerland = await farmContract.methods.cowLimitPerLand(rarity).call()
      let _bullLimitPerland = await farmContract.methods.bullLimitPerLand(rarity).call()
