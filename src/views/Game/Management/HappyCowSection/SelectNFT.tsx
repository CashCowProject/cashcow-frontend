    ...
    >
      <div style={{ display: 'flex', justifyContent: 'center', position: 'relative' }}>
        <Heading as="h1" size="lg" color="primary" mb="25px" style={{ textAlign: 'center', width: '600px' }}>
          <BoxShadow style={{ borderRadius: '16px', padding: '24px' }}>Pick your Happy Cow</BoxShadow>
        </Heading>
        <div
              ...
              <div className={'each-happy-cow-image-container'}>
                {happyCowStakedBreeds.includes(nft.breed) ? (
                  <>
                    ...
                    />
                    <div className="each-happy-cow-card-text">Cannot add more {nft.breed} to farm!</div>
                  </>
                ) : (
                  <>
                    <img
                    ...
                    />
                    <div className="each-happy-cow-card-text">{nft.name}</div>
                  </>
                )}
              </div>
            ))}
