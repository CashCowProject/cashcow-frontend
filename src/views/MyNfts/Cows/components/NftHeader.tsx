...
const filterByBreed = [
  { label: 'All Breeds', value: { field: 'All', direction: 'asc' } },
  { label: 'Highland', value: { field: 'Highlands', direction: 'desc' } },
  { label: 'Holstein', value: { field: 'Holstein', direction: 'asc' } },
  { label: 'Hereford', value: { field: 'Hereford', direction: 'asc' } },
  { label: 'Brahman', value: { field: 'Brahman', direction: 'asc' } },
  { label: 'Angus', value: { field: 'Angus', direction: 'asc' } },
]
...
const NftHeader = () => {
  ...
  const fetchInfo = useCallback(async () => {
    const nftAmount = await cowNftContract.methods.balanceOf(account).call()
    setTotalAmount(nftAmount);
  }, [account, cowNftContract])
